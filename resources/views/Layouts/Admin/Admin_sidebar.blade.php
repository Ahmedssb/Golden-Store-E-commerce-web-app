                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="fa fa-puzzle-piece"></i><a href="{{route('Category.Index')}}">View Categories</a></li>
                            <li><i class="fa fa-id-badge"></i><a href="{{route('Category.Add')}}">Add</a></li>
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="fa fa-table"></i><a href="{{route('Product.Index')}}">View Products</a></li>
                            <li><i class="fa fa-table"></i><a href="{{route('Product.Add')}}">Add</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="menu-icon fa fa-th"></i><a href="{{route('Admin.Orders')}} ">View Orders</a></li>
                         </ul>
                    </li>
